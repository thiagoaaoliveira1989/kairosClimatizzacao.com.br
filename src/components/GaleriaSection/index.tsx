...
export const GallerySection = () => {
    ...
    return (
        <section id="galeria" className="w-[100vw] h-[100vh] pt-[130px] mt-[22rem] lg:mt-0" >
            <h1 className=" mt-[80px] lg:mt-[130px] text-[2.5rem] lg:text-[3.5rem] font-bold text-center">Galeria</h1>
            <div className='relative top-0 left-0 w-full h-full'>
                ...
                <div className='absolute top-[45%] px-[4rem] w-[100%] flex justify-between'>
                    <button
                        onClick={handlePrev}
                        className=' font-bold '>
                        <FaCircleArrowLeft
