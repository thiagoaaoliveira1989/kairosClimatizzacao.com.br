        ...
        <section className="bg-black bg-opacity-50 w-full h-full z-10 absolute">
            <div className="bg-gray-400 bg-opacity-95 mt-[150px] container flex m-auto h-auto gap-3 pb-5">
                ...
                <div className="mt-[3rem] flex flex-col gap-3 p-6">
                    <h1 className='text-primary font-primary text-center text-[2rem] font-bold' > Profissionalismo e Eficiência na Instalação de Sistemas de Ar Condicionado para Residências e Apartamentos </h1>
