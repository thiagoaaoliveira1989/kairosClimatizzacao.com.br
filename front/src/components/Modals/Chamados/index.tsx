  ...
  return (
    <section className="bg-black bg-opacity-50 w-full h-full z-10 absolute">
      <div className="bg-gray-400 bg-opacity-95 mt-[100px] p-[1rem] container flex m-auto h-auto gap-3 pb-5">
        <button onClick={openModalChamados} className="btn ml-[-1rem] absolute container z-10 text-primary font-primary text-[2rem] flex justify-end p-4">
          {' '}
          X{' '}
        </button>
        <form onSubmit={handleSubmit} className="mt-8 sm:w-[90%] lg:w-[50%] mx-auto p-8 bg-white rounded-lg shadow-md flex flex-col">
