...
export const LimpezaModal: React.FC<ILimpezaModalProps> = ({ handleOpenAndCloseModalLimpeza }) => {
    ...
    return (
        ...
        <div className="bg-gray-400 bg-opacity-95 mt-[150px] container sm:flex sm:flex-col lg:flex lg:flex-row m-auto h-auto gap-3 pb-5">
            ...
            <div className="flex flex-col gap-3 px-[2rem]">
                    <h1 className=' mt-[3rem] text-primary font-primary text-center text-[2rem] font-bold' > Garanta o Desempenho e a Qualidade do Ar com a Limpeza Profissional de Ar Condicionado </h1>
