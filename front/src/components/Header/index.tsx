...
export const Header = () => {
    ...
    return (
        <>
            ...
            {handleModalChamados === true ? <div className='mt-[50px]'> <ChamadosModal openModalChamados={openModalChamados}  /> </div> : null}
            {handleModalAgendamento === true ? <div className='mt-[50px]'>  <AgendamentoModal openModal={openModal} />  </div> : null}
        </>
